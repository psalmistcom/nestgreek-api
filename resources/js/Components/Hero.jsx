...
export default function Hero({ latestProperty, propLink }) {
    return (
        <section className="bg-white dark:bg-gray-900 py-12 sm:py-12">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                <Link
                    href={route(propLink)}
                    className="inline-flex justify-between mt-[25px] items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gradient-to-br from-green-400 to-blue-600 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700"
                    role="alert"
                >
                ...
                <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    <form>
                        ...
                        <div className="relative">
                            ...
                            />
                            <PrimaryButton className="ms-4 block">
                                Search
                            </PrimaryButton>
                            {/* <TextInput
                                id="email"
